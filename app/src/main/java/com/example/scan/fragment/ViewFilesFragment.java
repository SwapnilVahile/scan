package com.example.scan.fragment;
...
import com.example.scan.ViewFilesAdapter;
import com.example.scan.ViewFilesDividerItemDecoration;
...
public class ViewFilesFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        root = inflater.from(parent.getContext()).inflate(R.layout.fragment_view_files, parent, false);
